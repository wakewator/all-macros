DELAY : 1000
COMMENT : Healing prog for char with 107 Wiz Haste
COMMENT : Has some tweaks in to try and work with gear change
COMMENT : F1=Body
COMMENT : Runes: F2, F3, F11, Sh-F11
COMMENT : F4=Regen, F5=Sup Heal
COMMENT : F8=Food, F9=Blank/crate
COMMENT : F10=Stam Pot
COMMENT : F12=DEss/GSP - whatever
